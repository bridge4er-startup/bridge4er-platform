...
DROPBOX_AUTO_SYNC_COOLDOWN_SECONDS = env_int("DROPBOX_AUTO_SYNC_COOLDOWN_SECONDS", 1, minimum=1)
DROPBOX_LIST_CACHE_TTL_SECONDS = env_int("DROPBOX_LIST_CACHE_TTL_SECONDS", 1, minimum=1)
